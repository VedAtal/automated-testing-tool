 ...
 * psu.hpp:
 ***********************************************************************
 * Power Supply Unit. Interfaces with:
...
#ifndef PSUCONTROLLER
#define PSUCONTROLLER
...
class PSUController {
    private:
        ...
        /** Max voltage output after 0-5V is scaled by the opertational amplifier. */
        const double MAX_OUTPUT_VOLTAGE = 30.3; // IMPORTANT VALUE, ENSURE CORRECTNESS
    ...
    public:
         ...
         */
        int initPSU(SPIDriver& spi, GPIODriver& gpio);
         ...
         * @param voltage the desired voltage to be applied, 0-40V.
