...
#ifndef DIOCONTROLLER
#define DIOCONTROLLER
...
class DIOController {
    private:
        /** List of all expanders and their associated pins [1, 2, ... 15, 16]. */
        typedef enum {
    ...
    public:
        ...
        */
        ...
        /**
         * Completes proper intialization procedure to ensure DIO board is in ready state.
         * Ensures expanders are reset and not communication over the SPI bus on bootup.
         * @param spi a SPI diver.
         * @param gpio a GPIO driver.
         * @returns -1 if initialization failed.
         */
        int initDIO(SPIDriver& spi, GPIODriver& gpio);
