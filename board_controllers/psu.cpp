...
int PSUController::initPSU(SPIDriver& spi, GPIODriver& gpio) {
...
void PSUController::applyVoltage(SPIDriver& spi, GPIODriver& gpio, int dacOutput, double voltage, int cs) {
...
uint16_t PSUController::dacInputData(double voltage) {
